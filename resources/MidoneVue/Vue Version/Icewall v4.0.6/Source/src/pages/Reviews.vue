...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Reviews</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    >
      <div class="flex w-full sm:w-auto">
        ...
        <FormSelect class="w-48 ml-2 xl:w-auto !box">
      ...
      <div
        class="flex flex-wrap items-center w-full mt-3 xl:w-auto xl:flex-nowrap gap-y-3 xl:mt-0"
      >
      ...
      <Table class="border-spacing-y-[10px] border-separate -mt-2">
        <Table.Thead>
          <Table.Tr>
            ...
            <Table.Th class="border-b-0 whitespace-nowrap"> PRODUCT </Table.Th>
            <Table.Th class="border-b-0 whitespace-nowrap"> NAME </Table.Th>
            <Table.Th class="border-b-0 whitespace-nowrap"> RATING </Table.Th>
        ...
        <Table.Tbody>
          ...
          >
            ...
            <Table.Td
              class="first:rounded-l-md last:rounded-r-md !py-4 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
            >
              <div class="flex items-center">
                <div class="w-10 h-10 image-fit zoom-in">
                  <Tippy
                    ...
                    class="border-white rounded-lg border-1 shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]"
                    :src="faker.images[0]"
            ...
            <Table.Td
              class="first:rounded-l-md last:rounded-r-md whitespace-nowrap bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
            >
            ...
            <Table.Td
              class="first:rounded-l-md last:rounded-r-md text-center whitespace-nowrap bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
            >
