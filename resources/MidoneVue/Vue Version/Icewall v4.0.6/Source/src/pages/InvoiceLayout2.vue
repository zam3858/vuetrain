...
<template>
  ...
  <div class="mt-5 overflow-hidden intro-y box">
    <div
      class="flex flex-col px-5 pt-10 text-center lg:flex-row sm:px-20 sm:pt-20 lg:pb-20 sm:text-left"
    >
    ...
    <div
      class="flex flex-col px-5 pt-10 pb-10 text-center border-b lg:flex-row sm:px-20 sm:pb-20 sm:text-left"
    >
      <div>
      ...
      <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
        ...
        <div class="mt-2 text-lg font-medium text-primary">#1923195</div>
